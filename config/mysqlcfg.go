...
var (
	mysqlDBPath   = flag.String("mysql_db_path", "conf/mysql/db/", "Mysql DB configure path")
	mysqlSqlPath  = flag.String("mysql_sql_path", "conf/mysql/sql/", "Mysql SQL configure path")
